...
<#====================================================================
 ...
 So i scriptet the whole thing for you:-). I have a ton of experience starting the
 evil User Profile Synchronization Service, have not yet found one I could not start!

 You will want to run the script on the appserver that is running the User 
 Profile Synchronization service.

 The script only targets the server you are running the script on 
 and does the following:

-Disables the User profile Synchronization service (Even stuck ones!).
-Deletes the awfull timerjob ProfileSynchronizationSetupJob.
-Clears away all ForefrontManagerIdentity Certificates from the local machine
 certificate stores.
-Clears the SharePoint Confiugration Cache.
-Gives you a choice to start the Synchronization service, it will ask you to input the 
 farmadmin account password.
