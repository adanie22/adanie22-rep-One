...
namespace MWS.CUIT.AppControls.WebControls
{
    ...
    /// </summary>
    public class xHtmlEditableDiv : HtmlEditableDiv, IxControl
    {
        public xHtmlEditableDiv(UITestControl parent) : base(parent) { }

        public xHtmlEditableDiv(UITestControl parent, string id, string searchProperty = "Id")
            : base(parent)
        {
